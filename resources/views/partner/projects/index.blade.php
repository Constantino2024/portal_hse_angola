...
@section('title', 'Projectos · Parceiro')
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-5">
    <div class="mb-3 mb-md-0">
      <h1 class="section-title mb-2">
        <i class="fa-solid fa-diagram-project text-accent-orange me-2"></i>
        Projectos
      </h1>
      <div class="text-muted d-flex align-items-center gap-2">
        <i class="fa-solid fa-building-circle-check text-primary-dark"></i>
        <span>Divulgue projectos e cases da sua empresa</span>
      </div>
    </div>
    ...
    <div class="d-flex flex-column flex-md-row gap-3 w-100 w-md-auto">
        ...
        <form method="GET" class="d-flex">
          <div class="input-group flex-nowrap" style="min-width: 280px;">
            <input type="text" 
                   ...
                   placeholder="Buscar projecto ou cliente..." 
      ...
      <!-- New Project Button -->
      <a href="{{ route('partner.projects.create') }}" class="btn btn-primary d-flex align-items-center justify-content-center gap-2 w-100 w-md-auto">
      ...
      <div class="card border-0 shadow-sm rounded-3 h-100">
        <div class="card-body d-flex align-items-center gap-2">
          <div class="rounded-circle d-flex align-items-center justify-content-center d-none d-sm-flex" 
            ...
            <i class="fa-solid fa-diagram-project text-primary-dark fs-6"></i>
          </div>
          <div class="flex-grow-1">
            <div class="text-muted small">Total de Projectos</div>
    ...
    <div class="col-6 col-md-3">
      <div class="card border-0 shadow-sm rounded-3 h-100">
        <div class="card-body d-flex align-items-center gap-2">
          ...
          <div class="flex-grow-1">
            <div class="text-muted small">Projectos Ativos</div>
      ...
      <div class="card border-0 shadow-sm rounded-3 h-100">
        <div class="card-body d-flex align-items-center gap-2">
          <div class="rounded-circle d-flex align-items-center justify-content-center d-none d-sm-flex" 
            ...
            <i class="fa-solid fa-industry text-accent-orange fs-6"></i>
          </div>
          <div class="flex-grow-1">
            <div class="text-muted small">Sectores Diferentes</div>
            <div class="fw-bold fs-4">{{ $items->pluck('sector')->unique()->count() }}</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card border-0 shadow-sm rounded-3 h-100">
        <div class="card-body d-flex align-items-center gap-2">
          <div class="rounded-circle d-flex align-items-center justify-content-center d-none d-sm-flex" 
            ...
            <i class="fa-solid fa-map-location-dot text-secondary fs-6"></i>
          </div>
          <div class="flex-grow-1">
            <div class="text-muted small">Localizações</div>
            <div class="fw-bold fs-4">{{ $items->pluck('location')->unique()->count() }}</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
    <div class="card-header bg-white border-0 py-3 px-3 px-md-4">
      <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
        <h5 class="fw-semibold mb-0">Lista de Projectos</h5>
        <div class="text-muted small text-md-end">
          Mostrando {{ $items->firstItem() ?? 0 }}-{{ $items->lastItem() ?? 0 }} de {{ $items->total() }} projectos
        </div>
      </div>
    </div>
            ...
            <tr class="bg-light">
              <th class="px-3 px-md-4 py-3 border-0" style="min-width: 280px;">
                <div class="d-flex align-items-center gap-2">
                  <i class="fa-solid fa-diagram-project text-primary-dark"></i>
                  <span>Projecto</span>
                </div>
              </th>
              <th class="px-3 px-md-4 py-3 border-0">
                <div class="d-flex align-items-center gap-2">
                  <i class="fa-solid fa-industry text-primary-dark"></i>
                  <span>Sector</span>
                </div>
              </th>
              <th class="px-3 px-md-4 py-3 border-0">
                <div class="d-flex align-items-center gap-2">
                  <i class="fa-solid fa-map-location-dot text-primary-dark"></i>
                  <span>Local</span>
                </div>
              </th>
          ...
          @forelse($items as $project)
            <tr class="border-top border-bottom-0">
              ...
              <td class="px-3 px-md-4 py-3">
                <div class="d-flex align-items-center gap-2">
                  @if($project->sector)
                  <span class="badge bg-primary-dark bg-opacity-10 text-primary-dark rounded-pill px-3 py-1">
                    {{ $project->sector }}
                  </span>
                  @else
              ...
              <td class="px-3 px-md-4 py-3 text-end">
                <div class="d-flex align-items-center justify-content-end gap-2">
                  ...
                  <!-- Delete Button -->
                  <form action="{{ route('partner.projects.destroy', $project) }}" 
                        method="POST" 
                        class="d-inline"
                        onsubmit="return confirm('Tem certeza que deseja remover este projecto? Esta ação não pode ser desfeita.');">
                    @csrf
                    @method('DELETE')
                    <button type="submit" 
            ...
            <tr>
              <td colspan="5" class="px-3 px-md-4 py-5 text-center">
                <div class="d-flex flex-column align-items-center justify-content-center py-4">
                  ...
                  <h5 class="fw-semibold mb-2">Nenhum projecto encontrado</h5>
                  <p class="text-muted mb-4">Comece divulgando seu primeiro projecto</p>
                  <a href="{{ route('partner.projects.create') }}" class="btn btn-primary d-inline-flex align-items-center gap-2">
              ...
              <div class="row g-2 mb-3">
                ...
                <div class="col-12">
                  <div class="d-flex align-items-center gap-2 text-muted small">
                    <i class="fa-solid fa-industry" style="font-size: 0.75rem;"></i>
      ...
      <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body">
          ...
          <div class="row g-2 g-md-3">
            <div class="col-6 col-md-3">
              <a href="{{ route('partner.projects.create') }}" 
                ...
                <span class="fw-semibold small text-center">Novo Projecto</span>
              </a>
            </div>
            <div class="col-6 col-md-3">
              <a href="#" 
            ...
            <div class="col-6 col-md-3">
              <a href="#" 
                 class="btn btn-outline-primary w-100 d-flex flex-column align-items-center justify-content-center p-2 p-md-3 rounded-3 hover-lift">
                <i class="fa-solid fa-chart-simple fs-3 mb-1 mb-md-2"></i>
                <span class="fw-semibold small text-center">Relatórios</span>
              </a>
            </div>
            <div class="col-6 col-md-3">
              <a href="#" 
                 class="btn btn-outline-primary w-100 d-flex flex-column align-items-center justify-content-center p-2 p-md-3 rounded-3 hover-lift">
                <i class="fa-solid fa-images fs-3 mb-1 mb-md-2"></i>
                <span class="fw-semibold small text-center">Galeria</span>
              </a>
            </div>
          </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Add project status toggle functionality
  document.querySelectorAll('.toggle-project-status').forEach(btn => {
    btn.addEventListener('click', function(e) {
      ...
      if (confirm(`Deseja ${isActive ? 'desativar' : 'ativar'} este projecto?`)) {
        // Make API call to update status
        fetch(`/partner/projects/${projectId}/toggle-status`, {
          method: 'POST',
          headers: {
        ...
        .catch(error => {
          ...
          alert('Erro ao atualizar status do projecto');
        });
      }
    });
  });
